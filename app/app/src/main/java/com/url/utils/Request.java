...
public class Request {
    ...
    Request(UrlClient webb, Method method, String uri) {
        this.webb = webb;
        this.method = method;
        this.uri = uri;
     ...
     * <br>
     * Setting a header this way has the highest precedence and overrides a header value set on a {@link UrlClient}
     * instance ({@link UrlClient#setDefaultHeader(String, Object)}) or a global header
     * ({@link UrlClient#setGlobalHeader(String, Object)}).
     * <br>
     ...
     *             names as constants in {@link UrlClient}, see HDR_xxx.
     ...
     * If you want to change the behaviour for all your requests, call {@link UrlClient#setFollowRedirects(boolean)}.
